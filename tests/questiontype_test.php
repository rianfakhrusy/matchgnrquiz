...
require_once($CFG->dirroot . '/question/type/matchgnrquiz/questiontype.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/matchgnrquiz/edit_matchgnrquiz_form.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_matchgnrquiz_test extends advanced_testcase {
    /** @var qtype_matchgnrquiz instance of the question type class to test. */
    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_matchgnrquiz();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'matchgnrquiz');
    }
    ...
    public function test_question_saving_foursubq() {
        ...
        $questiondata = test_question_maker::get_question_data('matchgnrquiz');
        $formdata = test_question_maker::get_question_form_data('matchgnrquiz');
        ...
        qtype_matchgnrquiz_edit_form::mock_submit((array)$formdata);

        $form = qtype_matchgnrquiz_test_helper::get_question_editing_form($cat, $questiondata);
