...
/**
 * Unit tests for the matchgnrquizing question type.
 *
 * @copyright 2010 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_matchgnrquiz_walkthrough_test extends qbehaviour_walkthrough_test_base {

    public function test_deferred_feedback_unanswered() {

        // Create a matchgnrquizing question.
    ...
    public function test_matchgnrquiz_with_tricky_html_choices() {
    ...
    public function test_matchgnrquiz_clear_wrong() {
