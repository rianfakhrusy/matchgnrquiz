...
/**
 * Test helpers for the matchgnrquiz question type.
 *
...
global $CFG;
require_once($CFG->dirroot . '/question/type/matchgnrquiz/question.php');


/**
 * Test helper class for the matchgnrquiz question type.
 *
 * @copyright  2013 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_matchgnrquiz_test_helper extends question_test_helper {
    ...
    /**
     * Makes a matchgnrquiz question about completing two blanks in some text.
     * @return object the question definition data, as it might be returned from
     * get_question_options.
     */
    public function get_matchgnrquiz_question_data_foursubq() {
        global $USER;
        $q = new stdClass();
        test_question_maker::initialise_question_data($q);
        $q->name = 'Matching question';
        $q->qtype = 'matchgnrquiz';
        $q->parent = 0;
     ...
     */
    public function get_matchgnrquiz_question_form_data_foursubq() {
        $q = new stdClass();
        $q->name = 'Matching question';
