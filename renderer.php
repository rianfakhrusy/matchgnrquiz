...
/**
 * Generates the output for matchgnrquizing questions.
 *
 * @copyright 2009 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_matchgnrquiz_renderer extends qtype_with_combined_feedback_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa,
        ...
        foreach ($stemorder as $key => $stemid) {
            ...
            $result .= html_writer::tag('td',
                    html_writer::label(get_string('answer', 'qtype_matchgnrquiz', $i),
    ...
    /**
     * Format each question stem. Overwritten by randomsamatchgnrquiz renderer.
     *
    ...
    public function format_stem_text($qa, $stemid) {
        ...
        return $question->format_text(
                    ...
                    $qa, 'qtype_matchgnrquiz', 'subquestion', $stemid);
    }
    ...
    public function correct_response(question_attempt $qa) {
        ...
        if (!empty($right)) {
            return get_string('correctansweris', 'qtype_matchgnrquiz', implode(', ', $right));
        }
    }
}
